        ...
        try (Scanner sc1 = new Scanner(System.in)) {
            ...
            while (a <= 8) {
                ...
                switch (opc) {
                    ...
                    case 1:
                        System.out.println("O seu saldo é:" + cnt.getSaldo());
                        break;
                    ...
                    case 2:
                        ...
                        System.out.println(
                                "Deposito no valor de " + cnt.getDeposito() + "Seu saldo é = " + cnt.getSaldo());
                        break;
                    ...
                    case 3:
                        ...
                        if (cnt.getSaque() <= cnt.getSaldo()) {
                            System.out.println(
                                    "Saque no valor de " + cnt.getSaque() + " Seu saldo é = " + cnt.getSaldo());
                            break;
                        } else {
                    ...
                    case 4:
                        ...
                        System.out.println("Numero da Conta " + cln.getConta());
                        break;
